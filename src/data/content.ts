...
export const content: Content = {
  manufacturers: {
    atlantic: {
      ...
      pools: [
        ...
        { shape: "Round", size: " 15'", price: "$3299" },
        { shape: "Round", size: " 18'", price: "$3499" },
        { shape: "Round", size: " 21'", price: "$3999" },
        { shape: "Round", size: " 24'", price: "$4199" },
        { shape: "Round", size: " 27'", price: "$4599" },
        { shape: "Oval", size: " 12' x 24'", price: "$4899" },
        { shape: "Oval", size: " 15' x 30'", price: "$5899" },
    ...
    aquaLeader: {
      ...
      pools: [
        { shape: "Round", size: " 12'", price: "$2699" },
        { shape: "Round", size: " 15'", price: "$3499" },
        { shape: "Round", size: " 18'", price: "$3899" },
        { shape: "Round", size: " 21'", price: "$4399" },
        { shape: "Round", size: " 24'", price: "$4699" },
        { shape: "Round", size: " 27'", price: "$5199" },
        { shape: "Oval", size: " 12' x 23'", price: "$6299" },
        { shape: "Oval", size: " 15' x 30'", price: "$7499" },
        { shape: "Oval", size: " 18' x 33'", price: "$7899" },
      ],
    },
    tivoli: {
      ...
      manufacturer: "Tivoli",
      pools: [
        { shape: "Round", size: " 15'", price: "$3199" },
        { shape: "Round", size: " 18'", price: "$3499" },
        { shape: "Round", size: " 21'", price: "$3899" },
        { shape: "Round", size: " 24'", price: "$4099" },
        { shape: "Oval", size: " 12' x 24'", price: "$5399" },
        { shape: "Oval", size: " 15' x 30'", price: "$6299" },
      ],
    },
    southPort: {
  ...
  additionalProducts: [
    ...
    { name: "Raypak Pool Heater", detail: "206A 206,000BTU", price: "$2199" },
    ...
    { name: "Olympic A-Frame Ladder", detail: "", price: "$359" },
    { name: "Royal Entrance Deck Steps", detail: "", price: "$549" },
  ],
